...
let safeComponents =
  ...
  let components =
    [
      "Saturn", "http://kcieslak.io/Reinventing-MVC-for-web-programming-with-F"
      "Fable", "http://fable.io"
...
let searchBox (model: Model) (dispatch: Msg -> unit) =
  Box.box' [CustomClass "cta" ]
    []
        ...
        [ Hero.head [ ]
          ...
          Hero.body [ ]
            [ Container.container [ Container.CustomClass Alignment.HasTextCentered ]
                [ h1 [ ClassName "title" ]
                    [ str "Proxy Croak Code Finder" ]
                  div [ ClassName "subtitle" ]
                    [ str "Find the codes you need to build your proxy deck" ] ] ] ]
